...
import { ReportsOperationsWalletsSchema, useOperationsWalletsReport, usePopapStore } from '@/entities/reports';
...
export function ReportsOperationsWalletsForm() {
    const { data: walletTypesData, isLoading: walletTypesLoading } = useWalletTypes();
    const { mutate: operationsWalletsReport, isPending } = useOperationsWalletsReport();
    ...
    const form = useForm<z.input<typeof ReportsOperationsWalletsSchema>>({
        resolver: zodResolver(ReportsOperationsWalletsSchema),
        defaultValues: {
            dateStart: '',
            dateEnd: '',
    ...
    const onSubmit = (values: z.input<typeof ReportsOperationsWalletsSchema>) => {
        operationsWalletsReport(values);
        setActive(false);
    };
